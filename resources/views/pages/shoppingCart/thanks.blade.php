    ...
    <div class="center-align thanks-background m-0 pt-4">
        <div class="row">
            <div class="white col s10 offset-s1 m6 offset-m3 l4 offset-l4 p-2 pb-2 thanks-rounded">
                ...
                <p>Nous vous remercions pour votre commande et la confiance que vous avez bien voulu nous accorder. Votre commande a bien été enregistré. Un mail vous a été envoyé.</p>
